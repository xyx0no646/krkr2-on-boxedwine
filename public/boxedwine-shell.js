...
let DEFAULT_ROOT_ZIP_FILE = "debian_gnu_wine_1.7.zip";
//params
let Config = {};
...
var spinnerElement = document.createElement('figure');
...
//loading
{
    ...
    var loadingImgPath = "./image/loading.png";
    var loadingImg = new Image();
    loadingImg.src = loadingImgPath;
    loadingImg.onload = () => ctx.drawImage(loadingImg, 0, 0);
}
...
function loadScreen() {
    if (Config.isAutoRunSet || Config.isRunningInline) {
        ...
        //        ctx.fillText("Running...", canvas.width / 2.5, canvas.height / 2);
        var loadingImgPath = "./image/running.png";
        var loadingImg = new Image();
        loadingImg.src = loadingImgPath;
        loadingImg.onload = () => ctx.drawImage(loadingImg, 0, 0);
    }
